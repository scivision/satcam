...
def fovcross(ncfn, tlefn, svn, vidfn, calfn, t0, tlim):
    ...
    # %% run scenario
    date = datetime(t0.year, t0.month, t0.day)
    ...
    nr, nc = findClosestAzel(azcam, elcam, aer['az'].values, aer['el'].values)
    # %%
...
if __name__ == '__main__':
    ...
    tlim = (datetime(2013, 4, 11, 10, 45), datetime(2013, 4, 11, 10, 46))
